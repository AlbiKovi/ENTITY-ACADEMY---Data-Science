...
/* 2. Next, run the following insert statements to add some data to the Products table: */
-- query 1
...
/* 3. Run a query to see all of the films in your Streaming Service queue. */
